...
void main()
{
    ...
    color = vec4((2.0f * random(v_TexCoord) -1.0f) * 300.0f,(2.0f * random(v_TexCoord * 0.5f) -1.0f) *300.0f,( 2*random(v_TexCoord * 0.3f) -1.0f)*300f,1.0f);
    //color = vec4(0.1,0.0,0.0,1.0f);
